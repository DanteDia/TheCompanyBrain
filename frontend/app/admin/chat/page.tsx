    ...
    <div className="flex h-dvh flex-col bg-stone-50">
      ...
      <div className="border-b border-stone-200 bg-white px-8 py-4">
        ...
        <p className="mt-1 text-sm text-stone-600">
          Internal chat — query your own knowledge graph. Same engine as the
          employee `/ask` interface, scoped to <strong>{ORGANIZATION.name}</strong>.
        </p>
      </div>
      ...
      <div className="border-t border-stone-200 bg-white">
        <div className="mx-auto max-w-3xl px-6 md:px-10 py-4">
          <Composer
            ...
            disabled={thinking}
            placeholder="Ask the Brain about your company…"
          />
        </div>
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-stone-600 max-w-md mx-auto">
        Query your company's operational knowledge — people, systems, access
        paths, processes, unwritten rules.
      </p>
